...
// ═══════════════════════════════════════════════════════════
const SESSIONS_API = 'https://sessions-api.theanimistapothecary.com';
const SESSIONS_TOKEN = '3bc65ac46ac36620c5f10e90b4d5cd14e6a4c45c1d33d419e3e18586f48b3bbc';
const PROJECT_FILTER = 'the-animist-apothecary'; // Only show this project's sessions
const GH_OWNER = 'theanimistapothecary';
const GH_REPO = 'the-animist-apothecary';
...
async function loadContext() {
  ...
  const CONTEXT_FILES = [
    ...
    { name: 'Project CLAUDE.md', path: './CLAUDE.md', category: 'instructions', gh: 'CLAUDE.md',
      desc: 'Project-specific directives and code guards for YOUR_APP_NAME. Defines mandatory behaviors (version stamping, push-on-change, CI versioning), code guards (media_spaces naming, showToast, Tailwind aap-* tokens, hero banner protection), on-demand doc loading triggers, and quick refs for the tech stack (Vanilla HTML/JS, Tailwind v4, Supabase, GitHub Pages, Capacitor 8).' },
    ...
    { name: 'CAD-SITE-PLANS.md', path: 'docs/CAD-SITE-PLANS.md', category: 'docs', gh: 'docs/CAD-SITE-PLANS.md',
      desc: 'End-to-end site plan generation guide for 123 Main Stive, Your City TX (Your County). Covers the two-machine pipeline (Almaca design workstation + Hostinger VPS automation backend), all deliverables (county permit sheets, 3D renders, interactive maps, automated permit packets), step-by-step workflows (QGIS base map → Blender 3D scene → BlenderBIM permit sheets → presentation renders → packet assembly), GIS data sources (TNRIS, USGS 3DEP LiDAR, FEMA flood, TCEQ environmental), and YOUR_APP_NAME integration plans (live property map, on-demand render API, automated permit packet generation).' },
  ];
