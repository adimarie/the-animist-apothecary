...
const FALLBACK_CONFIG = {
  ...
  colors: {
    primary: {
      ...
      accent: '#b8943c',
      accent_hover: '#d4aa4a',
      accent_light: 'rgba(184, 148, 60, 0.12)',
      border: '#2e2924',
    },
    status: {
      success: '#5a7c5a',
      ...
      warning: '#b8943c',
      warning_light: 'rgba(184, 148, 60, 0.15)',
      info: '#4a6b8a',
  ...
  email: {
    ...
    button: { background: '#b8943c', text_color: '#141210', border_radius: '4px', padding: '14px 36px', font_weight: '600', shadow: '0 2px 8px rgba(184, 148, 60, 0.30)' },
